  ...
  \AtBeginDocument{
    ...
    \setbox\notesbox=\vbox{
      ...
      \vskip-1in\hskip-1in\vbox{
        \vskip1cm
        \textcolor{light-gray}{\hrule width\paperwidth\vskip1cm}
        \textcolor{light-gray}{\hrule width\paperwidth\vskip1cm}
        \textcolor{light-gray}{\hrule width\paperwidth\vskip1cm}
        \textcolor{light-gray}{\hrule width\paperwidth\vskip1cm}
        \textcolor{light-gray}{\hrule width\paperwidth\vskip1cm}
 ...
 }
 {
    ...
    {%
      ...
      last logical shipout=3%
        ...
        {%
          ...
          center=\pgfpoint{.3\pgfphysicalwidth}{.83\pgfphysicalheight}%
        }%
        ...
        {%
          ...
          resized width=.5\pgfphysicalwidth,%
          resized height=.33\pgfphysicalheight,%
          center=\pgfpoint{.3\pgfphysicalwidth}{.17\pgfphysicalheight}%
        }%
	...
	\AtBeginDocument{
      ...
      \setbox\notesbox=\vbox{
        ...
        \vspace*{-10.1cm}
        \textcolor{light-gray}{\rule[-1.0cm]{1pt}{9.1cm}\hskip1cm}
        \textcolor{light-gray}{\rule[-1.0cm]{1pt}{9.1cm}\hskip1cm}
        \textcolor{light-gray}{\rule[-1.0cm]{1pt}{9.1cm}\hskip1cm}
        \textcolor{light-gray}{\rule[-1.0cm]{1pt}{9.1cm}\hskip1cm}
        \textcolor{light-gray}{\rule[-1.0cm]{1pt}{9.1cm}\hskip1cm}
