...
\begin{frame}
  ...
  \begin{tabular}{ll}
    ...
    Problem: & $\bar{x}$ is our {\color{red}one} estimate for $\mu$!
  \end{tabular}
...
\begin{frame}{What do we do?}
  ...
  \item<7-> If the evidence is {\color{red}\textit{``highly
    ...
    \blueText{reject the null hypothesis, otherwise we cannot reject
      the null hypothesis}.
  \end{enumerate}
...
\begin{frame}{How To State Results}
  ...
  \begin{block}{Reject $H_0$}
    ...
    confidence level assuming a normal distribution and a 
