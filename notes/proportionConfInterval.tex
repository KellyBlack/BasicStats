  ...
  \only<2->{%
    ...
    \item The sample proportion has a mean of $p$, and a standard
      ...
      \item Check to see if $p\cdot n \geq 5$, $(1-p)\cdot n \geq 5$ and
        ...
        %  $\sqrt{\frac{p(1-p)}{n}}$
        \item A {\color{red}$z$}-statistic can be
          {\color{red}approximated} using
          \begin{eqnarray*}
...
\begin{frame}
  ...
  \note{
    ...
    Assuming a normal approximation to the sample proportion and
    assuming the worst case, $p=\half$, then we should sample 4,269
    stocks. 
