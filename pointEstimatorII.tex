...
\iftoggle{clicker}{%
  ...
  \begin{frame}
    ...
    trials and count the number of ``yeses.'' The count follows what
    distribution?
...
\begin{frame}{Relative Efficiency}
  ...
  \begin{definition}
    The \redText{relative efficiency} between two \blueText{unbiased}
...
\begin{frame}{Mean Squared Error}
  ...
  \begin{definition}
    The \redText{mean squared error} for an estimator,
    $\hat{\theta}$ is
    \begin{eqnarray*}
