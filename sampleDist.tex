...
\iftoggle{clicker}{%
  \begin{frame}{Flip a Coin}
    ...
    Heads. Press the number associated with the count on your
    clicker. \\
    \begin{tabular}{l@{\hspace{3em}}l@{\hspace{3em}}l@{\hspace{3em}}l}
      A: 0  & B: 1  & C: 2 & D: 3
    \end{tabular}
...
\begin{frame}
  ...
  We generated a bunch of measurements:
  \begin{eqnarray*}
    x_1,~x_2,~x_3,\cdots,~x_n.
  \end{eqnarray*}
  Each measurement comes from a Bernoulli distribution with parameter
  $p$. We assume that they are all independent of one another.
  ...
  \uncover<2->{The sample proportion is a random variable!}
...
\begin{frame}
  ...
  mean 3,000 $\Omega$ and a standard deviation of 800 $\Omega$. What
  is the probability that a sample of fifty measurements will be
  between 2200 $\Omega$ and 3800 $\Omega$.
...
df & 0.1&0.05&0.025&0.01&0.005&0.001&5e-04\\ \hline
