...
\begin{frame}{In General}
  ...
  \only<1>{\includegraphics[width=5cm]{img/vennDiagram}}
  \only<2->{\includegraphics[width=5cm]{img/vennDiagramAnnotated}}
  \only<3->%
  {
...
\begin{frame}{Compliment}
  ...
  \only<1>{\includegraphics[width=5cm]{img/complimentVennOne}}
  \only<2>{\includegraphics[width=5cm]{img/complimentVennTwo}}
...
\iftoggle{clicker}{%
  \begin{frame}{Clicker Quiz}
    ...
    I pick one person at random. What is the probability that the person
    is female or age is between 16 and 21?
