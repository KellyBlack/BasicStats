...
\author{Kelly Black\\Clarkson University\\Division of Mathematics and
  ...
  Khrystyna Dilai and Justin Foster \\
  Clarkson University \\
  \vspace{5em}
}
...
\begin{center}
  ...
  first draft of many of the activities.
...
\include{hypothesisTesting}    % 23 and 24
\include{hypothesisTestReview} % 25 and 26

\chapter{Bivariate Data}
\include{bivariateData}
