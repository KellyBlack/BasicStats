...
\iftoggle{clicker}{%
  \begin{frame}
    ...
    \begin{tabular}{l@{\hspace{3em}}l@{\hspace{3em}}l@{\hspace{3em}}l}
      A: $C^{10}_6 \lp\frac{1}{6}\rp^6 \lp\frac{5}{6}\rp^4$ & 
      B: $C^{10}_4 \lp\frac{1}{6}\rp^4 \lp\frac{5}{6}\rp^6$  \\ [10pt]
      C: $C^{10}_6 \lp\frac{1}{2}\rp^4 \lp\frac{1}{2}\rp^6$ & 
      D: $C^{10}_4 \lp\frac{1}{2}\rp^6 \lp\frac{1}{2}\rp^4$
    \end{tabular}
